        ...
        {conflicts.length > 0 ? (
          <div className="space-y-4">
            ...
            <div className="p-2 bg-yellow-50 border border-yellow-200 rounded text-xs">
              <strong>Debug:</strong> Found {conflicts.length} conflicts. Current case date: {currentCase.hearingDate ? new Date(currentCase.hearingDate).toLocaleDateString() : 'No date'}
            </div>
